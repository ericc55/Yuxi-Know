...
export default {
  ...
  components: {
    ...
    noGraphData: 'No relationship graph data for current conversation',
    noWebSearchData: 'No web search data for current conversation',
    noKnowledgeBaseData: 'No knowledge base query data for current conversation',
    queryText: 'Query',
